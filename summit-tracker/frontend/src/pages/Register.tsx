    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-granite-900 via-granite-800 to-summit-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-granite-300">Begin your ascent</p>
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? 'Creating account...' : 'Start Climbing'}
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-granite-600">
              ...
              <Link to="/login" className="text-summit-600 hover:text-summit-700 font-semibold">
                Login
              </Link>
            </p>
          </div>
